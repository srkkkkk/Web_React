        ...
        <form onSubmit={handleSubmit(onSubmitForm)}>
            ...
            <div className="form-group mb-3">
                ...
                <input type="text" id="name" name="name" maxLength="50" 
                       ...
                       {errors.name && <div style={err}>กรุณาระบุชื่อสิ้นค้า</div>}
            </div>
            <div className="form-group mb-3">
                <label htmlFor="price">ราคาสินต้า *</label>
                <input type="number" id="price" name="price" min="0" step="any"
                       className="form-control form-control-sm"
                       {...register('price',{validate: value => parseFloat(value) > 0})} />
                       {errors.price && <div style={err}>กำหนดราคาสินค้าเป็นตัวเลขที่มากกว่า0</div>}
            </div>
            <div className="form-group mb-3">
                <label htmlFor="detail">รายละเอียดสินต้า *</label>
                <textarea id="detail" name="detail" row="2" maxLength="250"
                       className="form-control form-control-sm"
                       {...register('detail',{required: true,minLength: 1,maxLength: 200})} >
                </textarea>
                       {errors.detail && <div style={err}>ต้องกำหนดรายละเอียดสินต้า</div>}
            </div>
            <div className="form-group mb-3">
                <label htmlFor="price">วันที่เพิ่มสินค้า *</label>
                <input type="date" id="dateAddes" name="dateAddes"
                       className="form-control form-control-sm" />
            </div>
            <div className="form-group mb-3">
